  ...
  <body class="grey lighten-4">
    ...
    ?>
    <form action="enviarFaltas.php?idTurma=<?php echo $idTurma?>&idMateria=<?php echo $idMateria;?>" method="POST">
    <?php 
      ...
      $name = "aluno"."$idUser";
    ?>
    <label><?php echo "$primeiroNome"; ?><input type="text" name="<?php echo $name;?>"></label>
  <?php } ?>
